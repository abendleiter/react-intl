...
function formatMessage(config, state) {
    ...
    var defaultMessage = messageDescriptor.defaultMessage || messageDescriptor.msg;
...
var FormattedMessage = function (_Component) {
    ...
    createClass(FormattedMessage, [{
        ...
        value: function render() {
            ...
            var descriptor = { id: id, description: ctx, defaultMessage: msg };
...
export { addLocaleData, intlShape, injectIntl, defineMessages, IntlProvider, FormattedDate, FormattedTime, FormattedRelative, FormattedNumber, FormattedPlural, FormattedMessage as M, FormattedHTMLMessage };